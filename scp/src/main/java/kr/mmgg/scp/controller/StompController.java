...
public class StompController {
    ...
    @GetMapping(value = "/lookupMember/{userId}/{email}", produces = MediaType.APPLICATION_JSON_VALUE)
    public ResultDto<List<UserToAddDto>> lookupMember(@PathVariable Long userId, @PathVariable String email) {
        return teamService.getUsersByEmail(userId, email);
    }
    // 채팅방 나가기
    @Transactional
